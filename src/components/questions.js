        ...
        <>
          ...
          <div className="text-left bg-gray-100 rounded-lg p-10">
            ...
            <p className="text-l text-gray-500">
              ...
              <br/>
              <br/>
              I felt a refresh was overdue, and an opportunity to get creative using exciting frameworks such as <b>Gatsby</b> and <b>Tailwind</b> was one I could not miss!
            </p>
            <br/>
