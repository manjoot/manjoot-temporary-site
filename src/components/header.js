    ...
    <header>
      <nav class="font-sans flex flex-col text-center sm:flex-row sm:text-left sm:justify-between py-4 px-6 bg-white shadow sm:items-baseline w-full">
        <div class="mb-2 sm:mb-0">
          <a href="https://github.com/manjoot/manjoot-site" class="text-2xl font-bold sm:tracking-tight text-gray-900 hover:text-gray-700"target="_blank"><span role="img" aria-label="construction">🚧</span> Manjoot <span role="img" aria-label="construction">🚧</span></a>
        </div>
        <div>
